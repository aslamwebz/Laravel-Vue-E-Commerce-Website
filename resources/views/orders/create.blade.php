        ...
        <div class="row">
            <div class="col-xl-12 order-xl-1">
                <div class="card bg-secondary shadow">
                    ...
                    <div class="col-md-8">
                        <div class="card-body">
                            <form method="POST" action="{{ route('orders.store') }}" autocomplete="off" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="pl-lg-4">
                                    <div class="form-group{{ $errors->has('order_to') ? ' has-danger' : '' }}">
                                        ...
                                        value="{{ old('order_to') }}" required autofocus>
                                    ...
                                    <div class="form-group{{ $errors->has('order_date') ? ' has-danger' : '' }}">
                                        ...
                                        value="{{ old('order_date') }}" required autofocus>
                                    ...
                                    <div class="form-group{{ $errors->has('order_details') ? ' has-danger' : '' }}">
                                        ...
                                        value="{{ old('order_details') }}" autofocus required>
                                    ...
                                    <div class="form-group{{ $errors->has('order_status') ? ' has-danger' : '' }}">
                                        ...
                                        value="{{ old('order_status') }}" required autofocus>
