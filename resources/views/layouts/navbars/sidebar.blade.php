    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{route('product.index')}}">
                        <i class="fas fa-warehouse text-orange"></i> {{ __('Inventory') }}
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{route('sales.index')}}">
                        <i class="fas fa-file-invoice-dollar text-orange"></i> {{ __('Sales') }}
                    </a>
                </li>
                <li class="nav-item">
            ...
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link" href="#">
                        <i class="ni ni-circle-08 text-pink"></i> {{ __('Administration') }}
                    </a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#">
                        <i class="ni ni-key-25 text-info"></i> {{ __('Logs') }}
                    </a>
                </li>
            </ul>
        </div>
